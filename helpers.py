...
faqs = {
        ...
        "Receiving Messages": {
            ...
            "I can't find my card on the last day of classes!": "Check your email from the morning of!  We always send instructions on how to find your messages.  If you can't find the email or still need help, send us an email at lifted@cornell.edu.  During Lifted Day, we'll respond within 1-15 minutes.",
