        ...
        <footer className="py-8 bg-neutral-900 text-white">
            <div className="max-w-7xl mx-auto px-4">
                ...
                <div className="border-t border-gray-800 pt-6 text-center text-sm text-gray-300 space-y-4">
                    <p>Version 4.2 (11/14/25) | <a href="https://reidserver.statuspage.io" target="_blank" className={footerLinkClass}>System Status</a> | <Link href="/about-this-website" className={footerLinkClass}>About this Website</Link></p>
