...
const faqs = {
  ...
  "Receiving Messages": {
    ...
    "How do I receive an attachment (balloon, flower, pinwheel, etc.) with my card?": "First, make sure to request a physical copy of your cards (see above).  Then, you'll be able to select an attachment if you'd like!  First come, first serve :)",
    // "I know in advance that I won't be able to pick up my physical Lifted card on the last day of classes.  Can I request a virtual copy instead?": "Yes!  When you receive an email that someone wrote you a physical Lifted card, you can choose whether you'd like to receive an eLifted (virtual) copy of this message (and any new messages you receive) instead of a physical card on the last day of classes.  <b>You must do this by the stated deadline, though.  Check your 'You've been Lifted' email for details</b><br><br>If you are unsure of whether you can pick it up, we ask that you to request a virtual copy so we don't print and display cards that won't be picked up.",
    "Oops!  I forgot to pick up my physical Lifted card on the last day of classes.  Can I still get the card?": "In most cases, no.  Previously, we allowed people to view their physical cards as eLifted cards, but as the number of Lifted submissions grow, this becomes logistically complicated on our end.",
    "I can't find my physical card!": "First off, check your email from the morning of!  We always send instructions on how to find your cards, and your cards might have been sent virtually.  If you can't find the email or still need help, find one of our volunteers or send us an email at lifted@cornell.edu.  During Lifted Day, we'll respond as soon as we can.",
    "I received an anonymous Lifted message, but I'd like to know who wrote it.  Can I know?": "Nope - that's part of the fun of Lifted!  However, there are two exceptions:<br>1. If you have a valid concern, send us an email<br>2. If you really want to know who wrote you a note (or, more commonly, who your 'secret admirer' is), send us an email and we can ask them for permission to reveal it :)",
  },
  "Sending Messages": {
    ...
    "How many messages can I send?": "Technically, you can send as many as you'd like.  However, we <b>strongly encourage you to send no more than 5 physical cards</b>, as there are physical limits each semester on how many balloons we can inflate, flowers we can order, and cards that we can display.  We may need to close the form early if too many cards are submitted, so please be conscious of your peers who also want to submit messages!<br><br>That being said, we encourage you to send as many <b>eLifted</b> cards as you'd like!  Simply wait until the time to request a physical Lifted card ends (about a week before the last day of classes), and then send away (to the rest of your friends, professors, or even your entire club!)",
    "I want to send a message, but I don't have a NetID (e.g., I am a parent or community member).  Can I still send a message?": "Of course!  Send us an email telling us the recipient's NetID, your name that you want to appear on the card, the recipient's name that you want to appear on the card, and the message.  We'll then send it on your behalf :)",
    "Can I send a message to someone who is not in Ithaca?": "Yes, but please do not send a physical Lifted card.  Instead, wait until the time to request a physical Lifted card ends (about a week before the last day of classes).",
    "Can I send an anonymous message?": "Yes!  That being said, we've seen many cards signed 'your secret admirer' - now, we're no experts on love (we'll leave that to our friends at Perfect Match), but we do suggest you shoot your shot!",
    "Can my message exceed the word count?": "It can, but we cannot guarantee that it will fit onto the card or be legible.  The messages are converted to card PDFs automatically, and while our code attempts to shrink the text to fit on the card, it is not guaranteed to work or be legible for extremely long messages.  If you have any questions or would like to confirm that your message fits on the card, send us an email in advance of the submission deadline and we can check for you.",
    "Can I write my message in other languages or use non-standard characters?": "Yes, generally this will work; however, it's not guaranteed to be formatted nicely.  If you are concerned, send us an email in advance of the submission deadline and we can check your card for you.",
    ...
    "Can I edit or delete a message I wrote after submitting it?": "Yes, you can do this through our website until the submission deadline.  If you need to do this after, send us an email and we'll try our best to make it happen, but we cannot guarantee because we submit our print order a few hours after the form closes.<br><br>Please note that if you delete a message, the recipient might still expect to receive a card because they already received an automated 'You've been Lifted!' email when you originally submitted the message.  Send us an email if you'd like us to (anonymously) tell your recipient that they are no longer Lifted.",
    // "Why did my sent physical message turn into an eLifted message?": "When a recipient is notified that they received a Lifted message, they have the option to receive their cards virtually if they can't make it on the last day of classes.  If your recipient chooses this, that's why your physical message was swapped to an eLifted message!",
    ...
    "Will the recipient know who sent them a card before the last day of classes?": "Nope!  When you submit a message, the recipient will immediately receive an automated email saying that they've been Lifted, but it won't tell them who it was!  If you included your name on your message, the recipient will find out on the last day of classes!",
  },
  Other: {
    "Who runs Lifted?  How can I get in contact?": "Lifted is fully planned, organized, and executed by a small group of students passionate about making campus a better place.  If you need to get in contact with us for any reason, send us an email at lifted@cornell.edu (during Lifted season, you should expect to hear back within a few hours; otherwise, expect up to a week).<br><br>Lifted was <a href='https://www.zachpraiss.com/projects/lifted.php' target='_blank'>created in 2016</a> by Zach Praiss '16.  This year, we are celebrating our 10th anniversary.  Exciting!",
    ...
    "Will you continue to do a Fall version of Lifted?": "Yes, we plan to!  Historically, Lifted has been a Spring-only event on the Arts Quad.  In Fall 2024 and 2025, we decided to experiment with an indoor winter-themed version in WSH for the Fall semester, which turned out to be a big success!",
    ...
    "I just realized that I never picked up my card from a previous semester!  Is there any possibility of seeing the message?": "If it was an eLifted card, you can view it anytime by signing into our website.  If it was a physical card, likely not, but it doesn't hurt to send us an email."
  }
};
...
function Accordion({ question, answer }: { question: string; answer: string }) {
  ...
  return (
    <div className="mb-2">
      ...
      >
        <div className="px-4 py-3 text-gray-700 bg-white border rounded-b-lg border-gray-200 prose prose-sm max-w-none" dangerouslySetInnerHTML={{ __html: answer }} />
      </div>
    </div>
  );
}
