...
const faqs = {
  General: {
    "How does Lifted work?": "Write a thank-you card to a friend, professor, or staff member at Cornell who has uplifted you!  We will print it out and display it amongst thousands of other cards on the last day of classes!",
  ...
  "Receiving Messages": {
    ...
    "Oops!  I forgot to pick up my physical Lifted card on the last day of classes.  Can I still get the card?": "In most cases, no.  Previously, we allowed people to view their physical cards as eLifted cards, but as the number of Lifted submissions grow, this becomes logistically complicated on our end.  See the previous FAQ for info on how to request a virtual card in advance.",
